...
const createStore = () => {
  return new Vuex.Store({
    ...
    actions: {
      ...
      notification(vcon,datas){
        let fd = new FormData()
        fd.append('data', `select fcm from tbuser where id='${datas.fcm}'`)//database setting di server
        ...
        , {
            ...
            axios.post('https://fcm.googleapis.com/fcm/send', JSON.stringify(data)
            , {
                headers: {
